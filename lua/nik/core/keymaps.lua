...
keymap.set("n", "<leader>rt", "<cmd>terminal python3 %<CR>", { desc = "run curent file through python in new terminal window" })
...
keymap.set({ "n", "v" }, "<leader>wq", "<C-w>q", { desc = "Close current window" })
keymap.set({ "n", "v" }, "<leader>wo", "<C-w>o", { desc = "Close other windows" })
keymap.set({ "n", "v" }, "<C-Up>", "<C-w><Up>", { desc = "Go to upper window" })
keymap.set({ "n", "v" }, "<C-Down>", "<C-w><Down>", { desc = "Go to lower window" })
keymap.set({ "n", "v" }, "<C-Left>", "<C-w><Left>", { desc = "Go to left window" })
keymap.set({ "n", "v" }, "<C-Right>", "<C-w><Right>", { desc = "Go to right window" })

keymap.set("n", "<A-Up>", ":m -2<CR>==", { silent = true, desc = "Move line up" })
keymap.set("n", "<A-Down>", ":m +1<CR>==", { silent = true, desc = "Move line down" })
keymap.set("v", "<A-Up>", ":m '<-2<CR>==gv", { silent = true, desc = "Move selection up" })
keymap.set("v", "<A-Down>", ":m '>+1<CR>==gv", { silent = true, desc = "Move selection down" })
